  ...
  return (
      <VStack width="100%" alignItems={'start'} mt="2">
          <HStack justifyContent={'space-between'} width="95%">
              <Heading as="h1" size="4xl" noOfLines={1} fontSize={'1.5rem'} fontFamily={theme.fonts} fontWeight="bold" color="gray.700">
              ...
              <HStack gap={2}>
                  ...
                  <IconButton
                      ...
                      aria-label="left"
                      onClick={() => scroll('right', 600, index)}
                      variant="solid"
                      color="white"
                      bg={theme.colors.palette_indigo}
                      size="xs"
