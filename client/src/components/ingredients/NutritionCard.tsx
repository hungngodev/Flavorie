...
import { border, Box, Heading, Tag, TagLabel, TagLeftIcon, Text, VStack} from '@chakra-ui/react';
...
const NutritionCard: React.FC<IngredientProps> = ({ amount, unitShort, originalName, nutrition }) => {
    const tags = [
        { 
            label: 'Calories',
            value: nutrition.nutrients.find(nutrient => nutrient.name === 'Calories')?.amount, 
            unit: 'kcal', icon: nutritionIcons.Calories, 
            bg: 'green.50', 
            borderbg: 'green.100', 
        ...
        { 
            ...
            unit: 'g', icon: nutritionIcons.Protein, 
            bg: 'blue.50',
            borderbg: 'blue.100', 
            iconborder: 'blue.200', 
            iconcolor: 'blue.500'
        ...
        { 
            ...
            unit: 'g', icon: nutritionIcons.Carbohydrates, 
            bg: 'orange.50',
            borderbg: 'orange.100',   
        ...
        { 
            ...
            unit: 'g', icon: nutritionIcons.Fat, 
            bg: 'pink.50',
            borderbg: 'pink.100',
            iconborder: 'pink.200',
            iconcolor: 'pink.500' 
        ...
        {   
            ...
            unit: 'g', icon: nutritionIcons.Fiber, 
            bg: 'purple.50',
            borderbg: 'purple.100',  
    ...
    return (
        <Box boxShadow="md" borderRadius="md" p={2} display="inline-block">
            <Heading as="h3" fontSize="15" mb={2} textAlign="left" fontWeight="bold">Nutrition per {amount}{unitShort}</Heading>
            <VStack spacing={2} alignItems="left" align="center">
                {tags.map((tag, index) => (
                    <Tag 
                        ...
                        />
                        <Box>
                            <TagLabel py="1" fontSize="10" fontWeight="bold" textColor="base.500">{tag.label}</TagLabel>
                            <Text fontSize="15" fontWeight="bold" mb="1">{tag.value} {tag.unit}</Text>
                        </Box>
                    </Tag>
                ))}
            </VStack>
