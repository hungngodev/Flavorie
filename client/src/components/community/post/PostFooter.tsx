...
const PostFooter = memo<PostFooterProps>(({ postData, postId, isFullPage, ...props }) => {
  const auth = useAuth();
              ...
              onClick={
                button.name === 'React'
                  ...
                  : button.name === 'Review'
                    ? () => reviewModal.onOpen()
                    : () => {
                        // console.log(`${window.location.href}/${location.pathname}/${postId}`);
                        // setUrl(() =>
                        //   window.location.href.includes(postId)
