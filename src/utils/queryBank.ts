...
export const eggIngredients: string[] = [
...
export const sauceIngredients: string[] = [
...
export const grainIngredients: string[] = [
...
export const fruitIngredients: string[] = [
...
export const nutIngredients: string[] = [
...
export const spiceIngredients: string[] = [
...
export const sweetIngredients: string[] = [
    "sugar", "brown sugar", "powdered sugar", "honey", "maple syrup",
    "agave nectar", "molasses", "corn syrup", "coconut sugar", "stevia",
    "sucralose", "aspartame", "saccharin", "monk fruit", "erythritol",
    "xylitol", "maltitol", "sorbitol", "date sugar", "barley malt",
    "rice syrup", "fruit juice concentrate", "cane sugar", "panela",
    "jaggery", "rapadura", "treacle", "golden syrup", "blackstrap molasses",
    "corn sugar", "muscovado sugar", "demerara sugar", "turbinado sugar",
    "palm sugar", "coconut nectar", "carob syrup", "yacon syrup", "mirin",
    "karo syrup", "glucose", "fructose", "galactose", "maltose", "lactose"
];

export const powderIngredients: string[] = [
    "flour", "baking powder", "baking soda", "yeast", "cornstarch",
    "arrowroot", "tapioca starch", "potato starch", "rice flour", "oat flour",
    "coconut flour", "almond flour", "soy flour", "wheat germ", "protein powder",
    "cocoa powder", "gelatin", "agar", "pectin", "xanthan gum", "guar gum",
    "psyllium husk", "chia seeds", "flaxseeds", "poppy seeds", "sesame seeds",
    "sunflower seeds", "pumpkin seeds", "nutritional yeast", "brewers yeast",
...
export const IngredientBank = {
    ...
    spice: spiceIngredients,
    sweet: sweetIngredients,
    powder: powderIngredients,
};
